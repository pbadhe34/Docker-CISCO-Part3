...
To deploy aplication stack on swarm sluster
  >docker stack deploy -c docker-SWARM-default-link-mongo.yml mongo-app

   Standlone embeded tomcat is running with port no + 8080 and app is connectiong to mongodb database on host named as 'api-database'.

   To run docker-compose -f docker-compose-default-link-mongo.yml up -d

  Get the ip addresss of java container.
  docker inspect java-mongodb_api_1.

 

  accessible as  
  get : http://192.168.0.13:5000/fruits

  upload new data
  post : http://192.168.0.13:5000/fruits

  fruit data for posting is 
  {"id":"5ff21435ecb65e5025a7341d","name":"MANGO BIG","color":"keshari"}
