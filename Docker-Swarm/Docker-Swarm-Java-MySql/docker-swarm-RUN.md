...
>docker stack deploy -c docker-swarm-default-link-mysql.yml userapp



  Access the app from

   http://192.168.0.13:5000/users

  Or with curl from comad line 
  curl http://192.168.0.13:5000/users
...
With dynamic service ports

  docker stack deploy -c docker-service-dynamicport.yml userapp

    
  Access the app from

   http://192.168.0.13:30001/users

  Or with curl from comad line 
  curl http://192.168.0.13:30001/users
